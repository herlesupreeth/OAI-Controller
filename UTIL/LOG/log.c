...
int logInit (void)
{
  ...
  g_log->log_component[CONTROLLER_AGENT].name = "CONTROLLER_AGENT";
  g_log->log_component[CONTROLLER_AGENT].level = LOG_DEBUG;
  g_log->log_component[CONTROLLER_AGENT].flag = LOG_MED;
  g_log->log_component[CONTROLLER_AGENT].interval = 1;
  g_log->log_component[CONTROLLER_AGENT].fd = 0;
  g_log->log_component[CONTROLLER_AGENT].filelog = 0;
  g_log->log_component[CONTROLLER_AGENT].filelog_name = "";
