...
/*! \file controller_agent_common.h
...
#ifndef CONTROLLER_AGENT_COMMON_H_
#define CONTROLLER_AGENT_COMMON_H_
...
typedef int (*controller_agent_message_decoded_callback)(
	mid_t mod_id,
       	const void *params,
	Protocol__ProgranMessage **msg
);

typedef int (*controller_agent_message_destruction_callback)(
	Protocol__ProgranMessage *msg
);
...
// typedef Protocol__ProgranMessage *(*controller_agent_timer_callback_t)(void*);

// typedef enum {
//   /* oneshot timer:  */
//   CONTROLLER_AGENT_TIMER_TYPE_ONESHOT = 0x0,

//   /* periodic timer  */
//   CONTROLLER_AGENT_TIMER_TYPE_PERIODIC = 0x1,

//   /* Inactive state: initial state for any timer. */
//   CONTROLLER_AGENT_TIMER_TYPE_EVENT_DRIVEN = 0x2,
  
//   /* Max number of states available */
//   CONTROLLER_AGENT_TIMER_TYPE_MAX,
// } eNB_agent_timer_type_t;

// typedef enum {
//   /* Inactive state: initial state for any timer. */
//   CONTROLLER_AGENT_TIMER_STATE_INACTIVE = 0x0,

//   /* Inactive state: initial state for any timer. */
//   CONTROLLER_AGENT_TIMER_STATE_ACTIVE = 0x1,

//   /* Inactive state: initial state for any timer. */
//   CONTROLLER_AGENT_TIMER_STATE_STOPPED = 0x2,
  
//   /* Max number of states available */
//   CONTROLLER_AGENT_TIMER_STATE_MAX,
// } eNB_agent_timer_state_t;

// typedef struct controller_agent_timer_args_s{
//   mid_t            mod_id;
//   Protocol__ProgranMessage *msg;
// } controller_agent_timer_args_t;



// typedef struct controller_agent_timer_element_s{
//   RB_ENTRY(controller_agent_timer_element_s) entry;
...
// } controller_agent_timer_element_t;

// typedef struct controller_agent_timer_instance_s{
//   RB_HEAD(controller_agent_map, controller_agent_timer_element_s) controller_agent_head;
// }controller_agent_timer_instance_t;
...
// err_code_t controller_agent_restart_timer(long *timer_id);
...
// RB_PROTOTYPE(controller_agent_map, controller_agent_timer_element_s, entry, controller_agent_compare_timer);
