...
/*! \file controller_agent_mac_internal.h
...
#ifndef CONTROLLER_AGENT_MAC_INTERNAL_H_
#define CONTROLLER_AGENT_MAC_INTERNAL_H_
...
// mac_stats_updates_context_t mac_stats_context[NUM_MAX_CONTROLLER];
...
// err_code_t controller_agent_enable_cont_mac_stats_update(mid_t mod_id, xid_t xid,
// 						  stats_request_config_t *stats_req);

// err_code_t controller_agent_disable_cont_mac_stats_update(mid_t mod_id);

// Functions after this might be used in printing onto the console the specific stats report. Needed

Protocol__ProgranMessage * controller_agent_generate_diff_mac_stats_report(Protocol__ProgranMessage *new_report,
...
// THe following two functions have not been implemented
...
#endif /*CONTROLLER_AGENT_MAC_INTERNAL_H_*/
